...
mw.loader.using('mediawiki.api').then(function() {
    window.ViewRemoved = $.extend({
        always: window.ViewRemovedAlways || false,
        _preload: 0,
        preload: function() {
            if (++this._preload == 2) {
                dev.i18n.loadMessages('ViewRemoved').then(this.init.bind(this));
            }
        },
        init: function() {
    ...
    mw.hook('dev.i18n').add(ViewRemoved.preload.bind(ViewRemoved));
    mw.hook('dev.chat.render').add(ViewRemoved.preload.bind(ViewRemoved));
