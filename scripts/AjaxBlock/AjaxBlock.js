    ...
    window.AjaxBlock = $.extend({
        ...
        onload: function(key, arg) {
            switch (key) {
                case 'i18n-js':
                    var lib = arg;
                    lib.loadMessages('AjaxBlock').then(this.onload.bind(this, 'i18n'));
                    break;
                case 'i18n':
                    var i18n = arg;
                    this.i18n = i18n;
                ...
                case 'banners':
                    if (this.isUCP) {
                        var require = arg;
                        this.BannerNotification = require(this.bannerModule).BannerNotification;
                    } else {
                        this.BannerNotification = window.BannerNotification;
                    }
            }
        ...
        preload: function() {
            ...
            if (this.isUCP) {
                // TODO: Potentially factor out into util function. It's not reused. Might be more readable!
                var modules = mw.loader.getModuleNames();
                this.bannerModule = modules.find(function(mod) {
                    return mod.slice(0, 'BannerNotifications-'.length) === 'BannerNotifications-';
                });
                mw.loader.using(this.bannerModule).then(this.onload.bind(this, 'banners'));
            } else {
        ...
        getBlockTarget: function(uri, title) {
            ...
            return decodeURIComponent(title.split('/')[1]).replace(/_/g, ' ');
        },
                    ...
                    children: [
                        {
                            ...
                            children: [
                                this.i18n.msg('reason').plain(),
                                {
                                    ...
                                    children: this.unblockReasons !== null ? this.buildSelectChildren(this.unblockReasons) : [],
                                    condition: this.unblockReasons !== null
                                },
                                {
                                    type: 'input',
                                    attr: {
