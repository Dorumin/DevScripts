...
(function() {
    ...
    window.ChatLinkPreview = $.extend({
        ...
        onMessage: function(model) {
            ...
            roomId = $(entry).closest('.Chat').attr('id').slice(5),
        ...
        // Note: no url encoding necessary
        loadLinkData: function(url) {
            return this.promisify($.ajax({
                url: 'https://services.wikia.com/opengraph?uri=' + url,
                xhrFields: {
