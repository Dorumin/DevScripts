...
(function() {
    ...
    $items.click(function(e) {
        ...
        $targ.closest(config.selector).addClass('arrow-navigation-highlighted');
    });
    $(document).click(function(e) {
        if ($(e.target).closest('#mw-content-text').length) return;
        $('.arrow-navigation-highlighted').removeClass('arrow-navigation-highlighted');
    }).keydown(function(e) {
    ...
    if (!config.noStyles) {
        mw.util.addCSS(
        config.selector + '.arrow-navigation-highlighted:not(.message-main),' + 
        config.selector + '.arrow-navigation-highlighted:not(.message-main) + li {\
